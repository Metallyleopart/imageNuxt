<template>
  ...
  <div class="p-5 font-poppins">
    ...
    <form class="flex justify-center max-w-md" @submit.prevent="fetchData(input)">
      <input class="bg-gray-400 placeholder:text-slate-100 text-white rounded-l-md border-0 outline-0 pl-4 pr-1 py-2.5 md:px-6" v-model="input" placeholder="Search in here" type="text" />
